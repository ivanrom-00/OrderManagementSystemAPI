...
builder.Services.AddDbContext<CustomerContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("CustomerServiceDatabase")));

// Register Services
builder.Services.AddScoped<ICustomerRepository, CustomerRepository>();
builder.Services.AddScoped<ICustomerService, CustomerManagementService>();
...
{
    options.AddPolicy("CustomerServicePolicy",
    builder =>
    {
        builder
...
// Use CORS policy
app.UseCors("CustomerServicePolicy");
